...
//      window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
    ...
    /**
     * 修改状态栏颜色，支持4.4以上版本
     * 设置状态栏黑色字体图标，适配4.4以上版本MIUIV6、Flyme和6.0以上版本其他Android
     *
     * @param activity
     * @return -1:4.4以下安卓系统 0:4.4以上其它安卓系统 1:MIUI 2:Flyme 3:android6.0
     */
    public static int setStatusBarColorLightMode(Activity activity, int colorId) {
        int result = -1;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            if (MIUISetStatusBarLightMode(activity.getWindow(), true)) {
                ...
                //4.4以上非Flyme、MIUI、Android 6.0的系统
